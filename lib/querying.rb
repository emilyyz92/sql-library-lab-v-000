...
def select_series_title_with_most_human_characters
  "SELECT title FROM series JOIN characters ON series.id = characters.series_id WHERE characters.name = 'human' GROUP BY characters ORDER BY COUNT(characters) DESC LIMIT 1;"
end
